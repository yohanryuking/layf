...
const contenidoModal = [{
    ...
    content: "El curso de ingles de LAYF te ofrece clases en vivo con profesores expertos en la materia, ejercicios interactivos y material didáctico actualizado. El curso se adapta a tu nivel y a tus objetivos, y te da flexibilidad de horario y certificado oficial."
}, {
    title: "Curso de Administración",
    content: "Este curso te enseñará  a gestinar una empresa en el ambito empresarial. Aprenderás sebre administración, negocios, ánalisis, planificacíon, liderazgo y ñetica. Al finalizar el curso, podrás resolver problemas reales en el mundo de los negocios y obtener un certificado que acredite tus competencias."
}, {
    title: "Traducciones orales y de documentos",
    content: "Este curso te introduce al desarrollo de sitios web dinámicos y responsivos. Aprenderás sebre los lenguajes y frameworks más utilizados en la web, como HTML, CSS, JavaScript, Bootstrap, jQuery y React. El curso es interactivo y práctico. con casos reales actividades y proyectos que te ayudarán a consolidar lo aprendido. El curso está dirigido a personas que quieran iniciarse o perfeccionarse en el mundo de la programacíon web, sin importar su nivel previo."
}];
